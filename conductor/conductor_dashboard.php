...
$query = "SELECT c.*, b.bus_name FROM conductor_details c  
          LEFT JOIN bus_details b ON c.bus_id = b.bus_id  
          WHERE c.conductor_name = ?";
...
if (isset($_GET['export_pdf'])) {
    ...
    $stream = "BT\n/F1 12 Tf\n50 750 Td\n(Passenger List - $conductor_name) Tj\nET\n";
...
<h2>Welcome, <?= htmlspecialchars($conductor_name); ?>!</h2>
...
<table>
    ...
    <tbody>
    <tr>
        <td><?= htmlspecialchars($details['conductor_id']); ?></td>
        <td><?= htmlspecialchars($details['conductor_name']); ?></td>
